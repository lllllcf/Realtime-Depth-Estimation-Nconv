from dataset.voidloader import *
...
for lr in learning_rate:
    for wd in weight_decay:
        train_dataset = DataLoader_VOID('/oscar/data/jtompki1/cli277/', 'train', apply_mask)
        train_loader = DataLoader(train_dataset, batch_size=1, shuffle=True, pin_memory=True)
        val_dataset = DataLoader_VOID('/oscar/data/jtompki1/cli277/', 'val', apply_mask)
