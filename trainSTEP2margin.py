...
for lr in [1e-3]:
    for wd in [1e-5]:
        train_dataset = DataLoader_NYU('/oscar/data/jtompki1/cli277/nyuv2/nyuv2', 'train', True)
        train_loader = DataLoader(train_dataset, batch_size=1, shuffle=True)
        val_dataset = DataLoader_NYU('/oscar/data/jtompki1/cli277/nyuv2/nyuv2', 'val', True)
...
print('---------------------------------------------------------------')
print('------------------------ Training Done ------------------------')
save_checkpoint(best_model, 3000, "./checkpoints", final_stats)
